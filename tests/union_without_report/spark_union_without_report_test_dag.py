"""
Integration test DAG for UnionJob (without_report test variant).

Replaces the former Oozie-based test workflow
(eu/dnetlib/iis/wf/transformers/common/union/without_report)
...
@dag(
    dag_id="spark_union_without_report_test",
    dag_display_name="Integration test for UnionJob (without_report variant)",
    ...
    params={
        ...
        "workingDir": Param(
            default="hdfs://iis-cdh5-test-m1.ocean.icm.edu.pl:8020/tmp/marek.horst/union-without-report-test",
            type="string",
...
def spark_union_without_report_test():
    """Three-step integration test for UnionJob (without_report variant)."""
...
spark_union_without_report_test()
