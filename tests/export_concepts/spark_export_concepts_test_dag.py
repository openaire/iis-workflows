"""
Integration test DAG for ExportConceptsTransformerJob (concepts test variant).

Replaces the former Oozie-based test workflow
(eu/dnetlib/iis/wf/transformers/export/concepts/test)
...
_DATA_ROOT = "eu/dnetlib/iis/wf/transformers/export/concepts/test/data"
_INPUT_JSON  = f"{_DATA_ROOT}/document_to_concept_id.json"
_OUTPUT_JSON = f"{_DATA_ROOT}/document_to_concept_ids.json"

_SCHEMA_DOCUMENT_TO_CONCEPT_ID  = "eu.dnetlib.iis.referenceextraction.researchinitiative.schemas.DocumentToConceptId"
...
@dag(
    dag_id="spark_export_concepts_test",
    dag_display_name="Integration test for ExportConceptsTransformerJob (concepts variant)",
    ...
    params={
        ...
        "workingDir": Param(
            default="hdfs://iis-cdh5-test-m1.ocean.icm.edu.pl:8020/tmp/marek.horst/export-concepts-test",
            type="string",
...
def spark_export_concepts_test():
    """Three-step integration test for ExportConceptsTransformerJob (concepts variant)."""
